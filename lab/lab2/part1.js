...
var query1;
query1 = _.findWhere (jeffGameList)
...
var query9;
query9 = _.difference (jeffGameList, nathanGameList);
console.log('Which games are exclusive to one collection? In other words, only owned by either Jeff or Nathan (but not both!).', query9);

var query10
query10 = _.union (query8, query9);
